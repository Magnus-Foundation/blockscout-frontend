...
| NEXT_PUBLIC_IS_TESTNET | `boolean`| Set to true if network is testnet (legacy; prefer NETWORK_TYPE) | - | `false` | `true` | v1.0.x+ |
| NEXT_PUBLIC_NETWORK_TYPE | `'devnet' \| 'testnet' \| 'mainnet'` | Network tier shown in UI badges; supersedes IS_TESTNET when set | - | `mainnet` | `devnet` | magnus-staccato-v5+ |
